...
/**
 * The SudokuGenerator class creates a random standard (9x9) Sudoku board through the use of
...
public class SudokuGenerator {
    ...
    /**
     * Given a cell's coordinates and a possible number for that cell, determine if that number can
     * be inserted into said cell legally.
     *
